            ...
            <div class="col-xl">
                <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center pb-2 p-2 pt-3">
                        ...
                        <a href="{{Route('permission.index')}}"><button id="create-permission-btn" class="mb-0 btn btn-primary">Back</button></a>
                    </div>
                        ...
                        <form id="apply-course-form" method="POST" action="{{ route('permission.store') }}">
                            ...
                            <div class="row">
                                <div class="mt-1 mb-1 col-12 col-md-6 col-lg-4 col-xl-4">
                                    <label class="form-label required-label" for="intake">permission Group Name</label>
                                    <input type="text" name="group_name" class="form-control" placeholder="Enter permission Group name...." value="{{ old('group_name') }}">
                                    @error('group_name')
                                        <div class="text-danger mt-1">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="mt-1 mb-1 col-12 col-md-6 col-lg-4 col-xl-4">
                                    <label class="form-label required-label" for="intake">permission Name</label>
                                ...
                                <div class="mt-1 mb-1 col-12 col-md-6 col-lg-4 col-xl-4">
                                    <label class="form-label required-label" for="status">permission Status</label>
