...
@section('content')
                ...
                <div class="col-xl">
                    <div class="card mb-4">
                        <div class="card-header d-flex justify-content-between align-items-center pb-2 p-2 pt-3">
                            ...
                            <a href="{{Route('permission.create')}}"><button id="create-permission-btn" class="mb-0 btn btn-primary">Create</button></a>
                        </div>
                        <div class="card-body p-1">
                            ...
                            <form method="GET" action="{{ route('permission.index') }}"
                                ...
                                <div class="input-group" style="width: 300px;">
                                    <input type="text" name="search" class="form-control" placeholder="Search for permissions"
    ...
    <script>
        $(document).ready(function() {
            function loadpermissions(filter = null,var_name = null) {
                ...
                $.ajax({
                    url: '{{ route('permission.fetch') }}', // Adjust this route as needed
                    type: 'GET',
                    data: formData,
                    success: function(response) {
                         $('#permissions_table').html(response.html);
            ...
            function CountData() {
                ...
                $.ajax({
                    url: '{{ route('permission.CountData') }}', // Adjust this route as needed
                    type: 'GET',
                    success: function(response) {
            ...
            $(document).on('click', '.filter-btn', function() {
                ...
                loadpermissions(permissionId,var_name);
            });
