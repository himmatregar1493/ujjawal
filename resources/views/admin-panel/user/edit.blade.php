            ...
            <div class="col-xl">
                <div class="card mb-4">
                    ...
                    <div class="card-body pb-2 p-2 pt-3">
                        ...
                        <form id="apply-course-form" method="POST" action="{{ route('user.update', $user['id']) }}" enctype="multipart/form-data" >
                            @csrf
                            <div class="row">
                                <div class="mt-1 mb-1 col-12 col-md-6 col-lg-4 col-xl-4">
                                    ...
                                    <br>
                                    <input type="file" name="file" id="file" class="form-control d-none" accept="image/*" >
                                    <div id="image-container">
                                        <img id="image-preview" src="{{asset('admin_assets\images\profile_pictures')}}\{{@$user['profile_picture']}}" alt="Image Preview" class="img-thumbnail" />
                                ...
                                <div class="mt-1 mb-1 col-12 col-md-6 col-lg-4 col-xl-4">
                                    ...
                                    <input type="text" name="email" id="email" autocomplete="off"  class="form-control" placeholder="Enter email..." value="{{ old('email',$user['email']) }}">
                                ...
                                <div class="mt-1 mb-1 col-12 col-md-6 col-lg-4 col-xl-4">
                                   ...
                                   $rolesIdsString = $user['roles_ids']; // Example: "1,2,3"
                                    $rolesIdsArray = explode(',', $rolesIdsString);
                                    @endphp
                                    <select class="form-control select2" id="selectRole" multiple name="role[]">
                                        @foreach($roles as $key => $value)
                                            <option value="{{ $value['id'] }}" {{ in_array($value['id'], old('role',$rolesIdsArray)) ? 'selected' : '' }}>{{ $value['name'] }}</option>
                                        @endforeach
                                    </select>
