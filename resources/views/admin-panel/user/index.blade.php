...
@section('content')
                ...
                <div class="col-xl">
                    <div class="card mb-4">
                        <div class="card-header d-flex justify-content-between align-items-center pb-2 p-2 pt-3">
                            ...
                            <a href="{{Route('user.create')}}"><button id="create-user-btn" class="mb-0 btn btn-primary">Create</button></a>
                        </div>
    ...
    <script>
        $(document).ready(function() {
            function loadusers(filter = null,var_name = null) {
                $('#users_table').html(`
                ...
                $.ajax({
                    url: '{{ route('user.fetch') }}', // Adjust this route as needed
                    type: 'GET',
                    data: formData,
            ...
            function CountData() {
                ...
                $.ajax({
                    url: '{{ route('user.CountData') }}', // Adjust this route as needed
                    type: 'GET',
                    success: function(response) {
