                ...
                <div class="col-xl">
                    <div class="card mb-4">
                        <div class="card-header d-flex justify-content-between align-items-center pb-2 p-2 pt-3">
                            <h5 class="mb-0">Comment type List</h5>
                            @if(UserCan('comment.create'))
                                <a href="{{Route('comment.create')}}"><button id="create-intake-btn" class="mb-0 btn btn-primary">Create</button></a>
                            @endif
    ...
    <script>
        $(document).ready(function() {
            function loadRoles(filter = null,var_name = null) {
                ...
                $.ajax({
                    url: '{{ route('comment.fetch') }}', // Adjust this route as needed
                    type: 'GET',
                    data: formData,
            ...
            function CountData() {
                ...
                $.ajax({
                    url: '{{ route('comment.CountData') }}', // Adjust this route as needed
                    type: 'GET',
                    success: function(response) {
