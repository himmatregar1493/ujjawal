                ...
                <div class="col-xl">
                    <div class="card mb-4">
                        <div class="card-header d-flex justify-content-between align-items-center pb-2 p-2 pt-3">
                            ...
                            {{-- <a href="{{Route('refund-request.create')}}"><button id="create-university-btn" class="mb-0 btn btn-primary">Create</button></a> --}}
                        </div>
                        <div class="card-body p-1">


                            <form method="GET" action="{{ route('refund-request.index') }}"
                                class="mb-2 mt-2 d-flex justify-content-end" id="findInTable">
                                <div class="input-group" style="width: 300px;">
                                    <input type="text" name="search" class="form-control" placeholder="Search by University Name from name ..."
    ...
    <script>
        $(document).ready(function() {
            function loadRoles(filter = null,var_name = null) {
                ...
                $.ajax({
                    url: '{{ route('refund-request.view_data_fetch') }}', // Adjust this route as needed
                    type: 'GET',
                    data: formData,
