<style>
            ...
            <tbody>
                @if (count($refund_requests) <= 0)
                 <div class="card-body d-flow" style="text-align:center;">
                    ...
                    @else
                    @foreach ($refund_requests as $item)
                    <tr>
                        <td>{{ $item['id'] }}</td>
                        ...
                        <td>
                            <a class="btn btn-primary btn-sm edit-intake-btn" href="{{ route('refund-request.edit', $item['id']) }}">
    ...
    <script>
        function change_status(element_id, id) {
            ...
            $.ajax({
                url: '{{ route('refund-request.change_status') }}', // Adjust this route as needed
                type: 'POST'
                , data: formData
