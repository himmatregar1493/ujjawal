            ...
            No record Found
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a class="btn btn-primary btn-sm edit-intake-btn" href="{{ route('client.view', $item['id']) }}">
                                <img src="{{ asset('assets/img/icons/crud_icon/view.png') }}" style="width:15px">
                            </a>

                            <a class="btn btn-primary btn-sm edit-intake-btn" href="{{ route('client.edit', $item['id']) }}">
