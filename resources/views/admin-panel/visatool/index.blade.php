                ...
                <div class="col-xl">
                    <div class="card mb-4">
                        <div class="card-header d-flex justify-content-between align-items-center pb-2 p-2 pt-3">
                            <h5 class="mb-0">Visa Tool</h5>
                            <a href="{{Route('visatool.create')}}"><button id="create-university-btn" class="mb-0 btn btn-primary">Create</button></a>
                        </div>
                        <div class="card-body p-1">
                            <div class="" id="counts_show">
                            </div>

                            <form method="GET" action="{{ route('visatool.index') }}"
    ...
    <script>
        $(document).ready(function() {
            function loadRoles(filter = null,var_name = null) {
                ...
                $.ajax({
                    url: '{{ route('visatool.fetch') }}', // Adjust this route as needed
                    type: 'GET',
                    data: formData,
            ...
            function CountData() {
                ...
                $.ajax({
                    url: '{{ route('visatool.CountData') }}', // Adjust this route as needed
                    type: 'GET',
                    success: function(response) {
