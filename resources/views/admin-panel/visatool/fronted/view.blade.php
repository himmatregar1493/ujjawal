    ...
    @foreach($documents as $document)
        ...
        <div class="col">
            <div class="card text-center">
                <img src="{{ $document['path'] }}" class="card-img-top custom-img" alt="{{ $document['name'] }}">
                <div class="card-body">
...
<script>
    function openDocument(link, extension) {
        ...
        if (extension === 'pdf') {
            ...
            iframe.src = 'https://docs.google.com/viewer?url=' + encodeURIComponent(link) + '&embedded=true';
