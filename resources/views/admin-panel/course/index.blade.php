                ...
                <div class="col-xl">
                    <div class="card mb-4">
                        <div class="card-header d-flex justify-content-between align-items-center pb-2 p-2 pt-3">
                            ...
                            <a href="{{Route('course.create')}}"><button id="create-university-btn" class="mb-0 btn btn-primary">Create</button></a>
                        </div>
    ...
    <script>
        $(document).ready(function() {
            function loadRoles(filter = null,var_name = null) {
                ...
                $.ajax({
                    url: '{{ route('course.fetch') }}', // Adjust this route as needed
                    type: 'GET',
                    data: formData,
            ...
            function CountData() {
                ...
                $.ajax({
                    url: '{{ route('course.CountData') }}', // Adjust this route as needed
                    type: 'GET',
                    success: function(response) {
