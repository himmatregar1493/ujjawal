            ...
            <div class="col-xl">
                <div class="card mb-4">
                    ...
                    <div class="card-body pb-2 p-2 pt-3">
                        ...
                        <form id="apply-course-form" method="POST" action="{{ route('client.update', $client->id) }}">
                            @csrf
                            @method('PATCH')
                            <div class="row">
                                <div class="mt-1 mb-1 col-12 col-md-6 col-lg-4 col-xl-4">
                                    ...
                                    <input type="text" id="client-name" name="name" class="form-control" placeholder="Enter client name...." value="{{ old('name', $client->name) }}">
                                    @error('name')
                                ...
                                <div class="mt-1 mb-1 col-12 col-md-6 col-lg-4 col-xl-4">
                                    ...
                                    <input type="email" id="client-email" name="email" class="form-control" placeholder="Enter client email...." value="{{ old('email', $client->email) }}">
                                    @error('email')
                                        <div class="text-danger mt-1">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mt-1 mb-1 col-12 col-md-6 col-lg-4 col-xl-4">
                                    ...
                                    <input type="text" id="client-phone" name="phone" class="form-control" placeholder="Enter client phone...." value="{{ old('phone', $client->phone) }}">
                                    @error('phone')
                                        <div class="text-danger mt-1">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mt-1 mb-1 col-12 col-md-6 col-lg-4 col-xl-4">
                                    ...
                                    <input type="text" id="client-alt-phone" name="alt_phone" class="form-control" placeholder="Enter client alternative phone...." value="{{ old('alt_phone', $client->alt_phone) }}">
                                    @error('alt_phone')
                                        <div class="text-danger mt-1">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mt-1 mb-1 col-12 col-md-6 col-lg-4 col-xl-4">
                                    ...
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" id="status" name="status" value="1" {{ old('status', $client->is_active) ? 'checked' : '' }}>
                                    </div>
                                    @error('status')
                                        <div class="text-danger mt-1">{{ $message }}</div>
                                    @enderror
