<style>
    ...
    <div class="detail-table">
        <table class="table">
            ...
            No record Found
                    ...
                    @else
                    @foreach ($entry_requirement as $item)
                    <tr>
                        <td>{{ $item['id'] }}</td>
                        ...
                        <td>
                            <a class="btn btn-primary btn-sm edit-intake-btn" href="{{ route('entry-requirement.edit', $item['id']) }}">
    ...
    <script>
        function change_status(element_id, id) {
            ...
            $.ajax({
                url: '{{ route('entry-requirement.change_status') }}', // Adjust this route as needed
                type: 'POST',
                data: formData,
        ...
        function CountData() {
            ...
            $.ajax({
                url: '{{ route('entry-requirement.CountData') }}',
                type: 'GET',
                success: function(response) {
