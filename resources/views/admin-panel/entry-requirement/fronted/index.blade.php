                        ...
                        <div class="card-body p-1">
                            ...
                            <form method="GET" action="{{ route('refund-request.index') }}"
                                ...
                                <div class="input-group" style="width: 300px;">
                                    <input type="text" name="search" class="form-control" placeholder="Search by Visa tools from name ..."
    ...
    <script>
        $(document).ready(function() {
            function loadRoles(filter = null,var_name = null) {
                ...
                $.ajax({
                    url: '{{ route('visatool.view_data_fetch') }}', // Adjust this route as needed
                    type: 'GET',
                    data: formData,
