                ...
                <div class="col-xl">
                    <div class="card mb-4">
                        <div class="card-header d-flex justify-content-between align-items-center pb-2 p-2 pt-3">
                            <h5 class="mb-0">Application Stage List</h5>
                            @if(UserCan('application-stage.create'))
                                <a href="{{Route('application-stage.create')}}"><button id="create-intake-btn" class="mb-0 btn btn-primary">Create</button></a>
                            @endif
                        ...
                        <div class="card-body p-1">
                            ...
                            <form method="GET" action="{{ route('application-stage.index') }}"
                                class="mb-2 mt-2 d-flex justify-content-end" id="findInTable">
                                <div class="input-group" style="width: 300px;">
                                    <input type="text" name="search" class="form-control" placeholder="Search for intakes"
    ...
    <script>
        $(document).ready(function() {
            function loadRoles(filter = null,var_name = null) {
                ...
                $.ajax({
                    url: '{{ route('application-stage.fetch') }}', // Adjust this route as needed
                    type: 'GET',
                    data: formData,
            ...
            function CountData() {
                ...
                $.ajax({
                    url: '{{ route('application-stage.CountData') }}', // Adjust this route as needed
                    type: 'GET',
                    success: function(response) {
