...
@section('content')
                    ...
                    <div class="card mb-4">
                        <div class="card-header d-flex justify-content-between align-items-center pb-2 p-2 pt-3">
                            ...
                            University Presentation
                                {{-- <p style="font-size:12px;">Sample Visa Tools Form</p> --}}
                            </h5>
                            
                            {{-- <a href="{{Route('university-presentation.create')}}"><button id="create-university-btn" class="mb-0 btn btn-primary">Create</button></a> --}}
                        </div>
                        <div class="card-body p-1">


                            <form method="GET" action="{{ route('university-presentation.index') }}"
                                class="mb-2 mt-2 d-flex justify-content-end" id="findInTable">
                                <div class="input-group" style="width: 300px;">
                                    <input type="text" name="search" class="form-control" placeholder="Search by University Name ..."
    ...
    <div class="modal fade" id="documentModal" tabindex="-1" aria-labelledby="documentModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" style="max-width: 96% !important; max-height: 100vh !important;">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <iframe id="documentFrame" class="modal-iframe" ></iframe>
    ...
    <script>
        $(document).ready(function() {
            function loadRoles(filter = null,var_name = null) {
                ...
                $.ajax({
                    url: '{{ route('university-presentation.view_data_fetch') }}', // Adjust this route as needed
                    type: 'GET',
                    data: formData,
