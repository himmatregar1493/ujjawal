<style>
        ...
        <table class="table">
            ...
            No record Found
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-primary btn-sm edit-role-btn" href="{{ route('role.edit', $item['id']) }}">
    ...
    <script>
        function change_status(element_id, id) {
            ...
            $.ajax({
                url: '{{ route('role.change_status') }}', // Adjust this route as needed
                type: 'POST'
                , data: formData
