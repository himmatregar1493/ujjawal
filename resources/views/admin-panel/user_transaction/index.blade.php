                ...
                <div class="col-xl">
                    <div class="card mb-4">
                        <div class="card-header d-flex justify-content-between align-items-center pb-2 p-2 pt-3">
                            ...
                            <a href="{{Route('user_transaction.create')}}"><button id="create-intake-btn" class="mb-0 btn btn-primary">Create</button></a>
                            @endif
                        </div>
                        <div class="card-body p-1">
                            ...
                            <form method="GET" action="{{ route('user_transaction.index') }}"
    ...
    <script>
        $(document).ready(function() {
            function loadRoles(filter = null,var_name = null) {
                ...
                $.ajax({
                    url: '{{ route('user_transaction.fetch') }}', // Adjust this route as needed
                    type: 'GET',
                    data: formData,
            ...
            function CountData(formData = null) {
                $('#counts_show').html(`
                    <tr>
                        <td colspan="100">
                            <div class="w-100 d-flex">
                ...
                $.ajax({
                    url: '{{ route('user_transaction.CountData') }}', // Adjust this route as needed
                    type: 'GET',
                    data: formData,
                    success: function(response) {
